...
(async() => {
	...
	await runCli('npm i xcode --dev');
	await runCli('npm i');
	await runCli('echo \'installing fcm..\'');
	await runCli('npm i react-native-fcm --save');
	...
	await runCli('react-native unlink react-native-fcm');
	await runCli('react-native link react-native-fcm');
